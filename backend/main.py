...
from routes.appCallsListenerRoutes import router as appListener
from routes.dashboardListener import router as dashboardListener
...
app.include_router(appListener, prefix="/ws")
app.include_router(dashboardListener, prefix="/ws")
