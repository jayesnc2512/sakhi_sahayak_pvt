...
# Function to process the video and save annotated output with threat detection
def process_video(input_video_path, output_video_path, model_id="women-safety-hjfzs/1", frame_skip=5):
    # Open video file
...
# Use the function to process a video with frame skipping
input_video_path = '0'
output_video_path = 'annotated_1.mp4'

# Process only every 5th frame
process_video(input_video_path, output_video_path, frame_skip=5)
