  ...
  if (location) {
    const getNearbyPoliceStations = async () => {
      try {
        ...
        const url = `https://nominatim.openstreetmap.org/search?format=json&q=police+matunga|mumbai&limit=10&lat=19.025288&lon=72.853413`;
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
            ...
            <TouchableOpacity style={styles.policeStation}>
                ...
                <Text style={styles.phone}>+91 9853250223</Text>
                </View>
